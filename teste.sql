...
CREATE TABLE treinos (
    id INT AUTO_INCREMENT PRIMARY KEY,                 -- ID único para cada treino
    nome VARCHAR(255) NOT NULL,                        -- Nome do treino
    descricao TEXT NOT NULL,                           -- Descrição do treino
    duracao VARCHAR(50) NOT NULL,                      -- Duração do treino
    link_video_treino VARCHAR(255) NOT NULL,           -- Link para o vídeo do treino
    data_criacao TIMESTAMP DEFAULT CURRENT_TIMESTAMP,  -- Data de criação
    categoria VARCHAR(100) NOT NULL,                   -- Categoria do treino
    caminho_treino_url VARCHAR(255) NOT NULL           -- Caminho da URL para o treino
);
...
INSERT INTO tabela_exercicios (id, nome, repeticoes, link, treino_id) VALUES
